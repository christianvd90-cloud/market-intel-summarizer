...
class MarketSnapshot(BaseModel):
    ...
    open_interest: Optional[float] = Field(None, description="Open interest en USD o en contratos")
    order_book_imbalance: Optional[float] = Field(
        None, description="Ratio bid/ask volume, >1 = presion compradora"
    )
    price: Optional[float] = Field(None, description="Precio spot/futuro actual")
